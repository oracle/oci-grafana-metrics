...
exports.OCIDatasourceQueryCtrl = exports.SELECT_PLACEHOLDERS = undefined;
...
var SELECT_PLACEHOLDERS = exports.SELECT_PLACEHOLDERS = {
...
var OCIDatasourceQueryCtrl = exports.OCIDatasourceQueryCtrl = function (_QueryCtrl) {
  ...
  function OCIDatasourceQueryCtrl($scope, $injector, $q, uiSegmentSrv) {
    ...
    _this.target.resolution = _this.target.resolution || _constants.AUTO;
    _this.target.window = _this.target.window || _constants.AUTO;
  ...
  _createClass(OCIDatasourceQueryCtrl, [{
    ...
    value: function getRegions() {
      ...
      return this.datasource.getRegions().then(function (regions) {
        return _this2.appendVariables([].concat(_toConsumableArray(regions)), _constants.regionsQueryRegex);
      });
    }
  }, {
    key: 'getCompartments',
    value: function getCompartments() {
      ...
      return this.datasource.getCompartments().then(function (compartments) {
        return _this3.appendVariables([].concat(_toConsumableArray(compartments)), _constants.compartmentsQueryRegex);
      });
    }
  }, {
    key: 'getNamespaces',
    value: function getNamespaces() {
      ...
      return this.datasource.getNamespaces(this.target).then(function (namespaces) {
        return _this4.appendVariables([].concat(_toConsumableArray(namespaces)), _constants.namespacesQueryRegex);
      });
    }
  }, {
    ...
    value: function getResourceGroups() {
      ...
      return this.datasource.getResourceGroups(this.target).then(function (resourcegroups) {
        return _this5.appendVariables([].concat(_toConsumableArray(resourcegroups)), _constants.resourcegroupsQueryRegex);
      });
    }
  }, {
    key: 'getMetrics',
    value: function getMetrics() {
      ...
      return this.datasource.metricFindQuery(this.target).then(function (metrics) {
        return _this6.appendVariables([].concat(_toConsumableArray(metrics)), _constants.metricsQueryRegex);
      });
    }
  }, {
    key: 'getAggregations',
    ...
    value: function getWindows() {
      return this.appendWindowsAndResolutionVariables([].concat(_toConsumableArray(_constants.windows)), _constants.windowsAndResolutionRegex);
    }
  }, {
    key: 'getResolutions',
    value: function getResolutions() {
      return this.appendWindowsAndResolutionVariables([].concat(_toConsumableArray(_constants.resolutions)), _constants.windowsAndResolutionRegex);
    }
    ...
    value: function getDimensionOptions(segment, index) {
      ...
      if (segment.type === 'key' || segment.type === 'plus-button') {
        return this.getDimensionsCache().then(function (cache) {
          ...
          var vars = _this7.datasource.getVariables(_constants.dimensionKeysQueryRegex) || [];
      ...
      if (segment.type === 'value') {
        return this.getDimensionsCache().then(function (cache) {
          ...
          var vars = _this7.datasource.getVariables(_constants.dimensionValuesQueryRegex) || [];
