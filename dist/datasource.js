...
System.register(['lodash', './constants', './util/retry'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export('OCIDatasource', OCIDatasource = function () {
        ...
        _createClass(OCIDatasource, [{
          ...
          value: function templateMeticSearch(varString) {
            ...
            if (namespaceQuery) {
              var names = namespaces.map(function (reg) {
          ...
          value: function mapToTextValue(result, searchField) {
            ...
            var m = _.map(table.rows, function (row, i) {
              if (row.length > 1) {
      ...
      _export('OCIDatasource', OCIDatasource);
    }
  };
});
